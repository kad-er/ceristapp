...
<head>
    ...
    <link href="vendor/animate2.css/animate.min.css" rel="stylesheet">
            ...
            <nav class="nav-menu float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down active"><a href="services">Services</a>
                        <ul>
                            <li class="active"><a href="skin-segmentation">skin segmentation</a></li>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-8">
            <div class="tab-content">
              <div class="tab-pane tb active show" id="tab-1">
                <h3>Detection & Tracking</h3>
                <p class="fst-italic">Detected people in RGB-D data from dense depth data
(right) and color image data (left). The method neither relies on
background learning nor on a ground plane assumption.</p>
                <img src="img/detectd.png" alt="" class="img-fluid">
                
                  
              </div>
              <div class="tab-pane tb" id="tab-2">
                <h3>Customer Behavior Analysis</h3>
                <p class="fst-italic">Customer Behavior Analysis</p>
                <img src="img/customer.jpg" alt="" class="img-fluid">
               
              </div>
              <div class="tab-pane tb" id="tab-3">
                <h3>Density estimation</h3>
                <p class="fst-italic">Person density estimation. (a) Input image, (b) estimated density, and (c)
...
human count equals 303, while the given density predicts 294.</p>
              ...
              <div class="tab-pane tb" id="tab-4">
                ...
                <p class="fst-italic">People counting Use Case with Object Detection. Showing the box with the Region of Interest (ROI) and the crossing line.</p>
                <video autoplay muted loop id="bg-video">
                   <source src="img/video-p.mp4" type="video/mp4"  style="height: 48vh;min-width: 64%; width: 72%;"/>
                </video>
                <img src="img/video-p.mp4" alt="" class="img-fluid">
