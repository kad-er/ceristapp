      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down active"><a href="services">Services</a>
            <ul>
              <li class="active"><a href="sking-segmentation">skin segmentation</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="POST" action="{{ route('skinseg') }}" aria-label="{{ __('Upload') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label for="image"   class="col-sm-4 col-form-label text-md-right">{{ __('Title') }}</label>
                                <div class="col-md-6">
                                    <input id="image" name="image" type="file" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}"  required autofocus />
                                    @if ($errors->has('image'))
          ...
          <div class="col-md-4 d-flex align-items-stretch mx-auto" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="read-more"><a href="object-detection"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
